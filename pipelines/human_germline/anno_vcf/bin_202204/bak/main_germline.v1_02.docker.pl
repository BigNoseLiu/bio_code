...
my $docker_opt = "docker run -w $docker_out_dir -u 1002:1002 --rm -v $bio_dir:/biodata -v $out_dir:$docker_out_dir";
...
my $gatk_b37_mills			=	"/biodata/database/gatk_bundle/b37/Mills_and_1000G_gold_standard.indels.b37.vcf";
