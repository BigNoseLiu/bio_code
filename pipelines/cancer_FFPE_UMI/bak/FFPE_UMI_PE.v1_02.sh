...
somatic_raw_annovar="$out_prefix.21.merge.markdup.sorted.recal.somatic_raw.annovar"
...
$docker_cmd "perl $annovar -buildver hg19 -protocol refGeneWithVer  -operation gx $humandb  --remove --otherinfo --nastring . --vcfinput -out $somatic_raw_annovar"
