...
$docker_cmd "picard -Xmx8G CollectMultipleMetrics I=$recal_bam O=$sorted_multimetrics PROGRAM=CollectQualityYieldMetrics R=$ref INTERVALS=$interval_list  TMP_DIR=$temp_dir"
$docker_cmd "picard -Xmx8G CollectHsMetrics I=$recal_bam O=$sorted_HSmetrics R=$ref BAIT_INTERVALS=$interval_list TARGET_INTERVALS=$interval_list  TMP_DIR=$temp_dir"
