...
bed_file=/biodata/git_code/pipelines/cancer_FFPE_UMI/bed/cancer120.bed
interval_list=/biodata/git_code/pipelines/cancer_FFPE_UMI/bed/cancer120.bed.interval_list
