...
$docker_cmd "java -jar /biodata/git_code/software/snpeff/snpEff5_0/snpEff.jar -v GRCh37.p13.RefSeq -s /mnt/$current_dir/clinvar_20220416.snpeff.stat.html /mnt/$current_dir/clinvar_20220416.vcf.gz >/mnt/$current_dir/clinvar_20220416.snpeff.vcf"
