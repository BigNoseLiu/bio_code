...
my ($project,$Global,$Queue,$Interval, $Lines, $Maxjob, $Convert,$Secure,$Reqsub,$Resource,$Job_prefix,$Verbose, $Help, $getmem);
GetOptions(
	"pro:s"=>\$project,
	"global"=>\$Global,
	"lines:i"=>\$Lines,
...
while (@Shell) {
	...
	$job_cmd .= "-P $project"  if(defined $project); ##set projectid
